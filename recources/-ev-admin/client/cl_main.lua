...
RegisterNetEvent('ev:admin/client/fling-player', function()
...
RegisterNetEvent("ev:admin/client/select-spawn", function()
...
RegisterNetEvent("ev:admin:ReviveInDistance")
AddEventHandler("ev:admin:ReviveInDistance", function()
    local playerList = {}
    ...
    for index,value in ipairs(players) do
        ...
        if(distance < 50) then
            TriggerServerEvent('ev:admin:revive_in_distance')
...
AddEventHandler("ev:admin:noClipToggle", function(pIsEnabled)
