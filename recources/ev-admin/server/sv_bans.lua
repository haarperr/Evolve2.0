...
local count = 0
RegisterNetEvent("desirerp:admin/server/ban-player", function(ServerId, Expires, Reason)
    ...
    DropPlayer(ServerId,
        "You are banned, you may appeal it at https://discord.gg/aZ6mEsDE | Ban ID: " .. banId .. " | Reason: " .. pReason ..
            " | Unban Date: " .. unbanDate)
end)

local count = 0

RegisterNetEvent("desirerp:admin:unBan", function(pBanID)
    print(pBanID)
    local src = source
