...
Citizen.CreateThread( function()
    ...
    while true do
        ...
        if IsPedShooting(ped) then
            exports["ev-dispatch"]:dispatchadd('10-71', "Gunshots Reported", "110")
        end
        ...
        if armed then
            ...
            if not isCop and IsPedShooting(ped) and curw ~= w and curw ~= w2 and curw ~= w1 and curw ~= w3 and not origin then
                local inArea = false
