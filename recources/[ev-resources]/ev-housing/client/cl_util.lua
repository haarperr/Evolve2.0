...
function canRent()
    ...
    if isComplete and dist <= 3.0 then
        ...
        local canRent = RPC.execute("ev-housing:canRent", propertyId)
...
AddEventHandler("ev-housing:handler", function(data, cb)
...
Citizen.CreateThread(function()
    exports["ev-keybinds"]:registerKeyMapping("","Housing", "Interact", "+propertyInteract", "-propertyInteract", "E")
