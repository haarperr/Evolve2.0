...
RegisterNetEvent('ev-rpc:cl_request')
AddEventHandler('ev-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('ev-rpc:cl_response', src, origin, callId, response)
end)