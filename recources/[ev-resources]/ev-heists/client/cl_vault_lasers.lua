...
--         -- if not lasersActive and not blackout and #(laserDrawDistancePoint - playerCoords) < 20 then
--         --     lasersActive = true
--         --     activateLasers(true)
--         -- elseif exports['ev-blackout']:Blackout() then
--         --     local cityPowerState = false
--         --     lasersActive = false
