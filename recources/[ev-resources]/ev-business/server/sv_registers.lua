...
RPC.register("ev-business:startPurchase", function(pSource, pData)
    ...
    TriggerClientEvent("ev-business:activePurchase", -1, insert)
end)
...
RPC.register("ev-business:completePurchase", function(pSource, pData)
    ...
    local owner = exports["ev-base"]:getModule("Player"):GetUser(data.charger)
    ...
    TriggerClientEvent("ev-business:closePurchase", -1, insert)

    TriggerClientEvent('ev-phone:businessRegisterNoti', pSource, "SERVICE CHARGE", message)
