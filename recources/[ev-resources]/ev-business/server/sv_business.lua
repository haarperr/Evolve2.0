...
RPC.register("ev-business:business:GetEmploymentInformation", function(pSource)
    local user = exports["ev-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
...
RPC.register("ev-business:phone:GetEmploymentInformation", function(pSource)
    local user = exports["ev-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
...
RPC.register("ev-business:business:hasPermission", function(pSource, pBusinessId, pType)
    local hasPermission
...
RPC.register("ev-business:hasPermission", function(pSource, pBusinessId)
    local hasPermission
    local user = exports["ev-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
    local tableh = {}
...
RPC.register("ev-business:business:createRole", function(pSource, pBusinessId, pRoleName, pPermHire, pPermFire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank, pPermLogs)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local user = exports['ev-base']:getModule("Player"):GetUser(pSource)
...
RPC.register("ev-business:phone:createRole", function(pSource, pBusinessId, pRoleName, pPermFire, pPermHire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank, pPermLogs)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("ev-business:business:checkRoleExistance", function(pSource, pBusinessId, pCurRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
        local bool = false
...
RPC.register("ev-business:phone:checkRoleExistance", function(pSource, pBusinessId, pCurRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
        local bool = false
...
RPC.register("ev-business:business:editRole", function(pSource, pBusinessId, pCurRole, pRoleName, pPermFire, pPermHire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank, pPermLogs)
...
RPC.register("ev-business:business:deleteRole", function(pSource, pBusinessId, pRole)
...
RPC.register("ev-business:phone:deleteRole", function(pSource, pBusinessId, pRole)
    local role = firstToUpper(pRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("ev-business:business:updateEmployee", function(pSource, pCid, pBusinessId, pNewRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("ev-business:phone:updateEmployee", function(pSource, pCid, pBusinessId, pNewRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("ev-business:business:hireEmployee", function(pSource, pCid, pRole, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
        local employees = nil
...
RPC.register("ev-business:phone:hireEmployee", function(pSource, pCid, pRole, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
        local employees = nil
...
RPC.register("ev-business:business:fireEmployee", function(pSource, pCid, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("ev-business:phone:fireEmployee", function(pSource, pCid, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("ev-business:business:GetEmploymentInformationBusinessID", function(pSource, pCid, pBusinessId)
...
RPC.register("ev-businesses:getRoleAndEmployeesList", function(pSource, pBID)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBID
    }))
    local employees = json.decode(data[1].employees) or {}
...
RPC.register("ev-business:phone:GetRolePermission", function(pSource, pBusinessId, pRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("ev-business:business:GetEmploymentInformationBusinessID:Full", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local luckylucky = {}
...
RPC.register("ev-business:phone:GetEmploymentInformationBusinessID", function(pSource, pCid, pBusinessId)
    local userInfo = Await(SQL.execute("SELECT first_name, last_name FROM characters WHERE id = @id", {
        ["id"] = pCid
    }))
...
RPC.register("ev-business:business:GetBusiness", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local employment = {}
...
RPC.register("ev-business:phone:GetBusiness", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local employment = {}
...
RPC.register("ev-business:business:GetOwner", function(pSource, pBusinessId)
...
RPC.register("ev-business:business:GetBusinessRoles", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
            local allroles = {}
...
RPC.register("ev-business:phone:GetBusinessRoles", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
            local allroles = {}
...
RPC.register("ev-business:business:GetRole", function(pSource, pBusinessId, pRoleName)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("ev-business:business:addEmployee", function(pSource, pCid, pRole, pBusinessId)
...
RPC.register("ev-business:business:isBizOwner", function(pSource, pBusinessId)
    local user = exports["ev-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
...
RPC.register("ev-business:business:GetUserRole", function(pSource, pBusinessId, pCid)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
            local employees = json.decode(data[1].employees) or {}
...
RPC.register("ev-business:phone:GetUserRole", function(pSource, pBusinessId, pCid)
        local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
            ["business_id"] = pBusinessId
        }))
                local employees = json.decode(data[1].employees) or {}
...
RPC.register("ev-business:business:GetRolePermission", function(pSource, pBusinessId, pRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
            local roles = json.decode(data[1].roles) or {}
...
RPC.register("ev-business:getBizBank", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("ev-business:role:test", function(pSource, pData)
...
RPC.register("ev-business:business:charge", function(pSource, pBusinessId, pCid, pCharger, pAmount, pComment)
    TriggerClientEvent("showPaymentNotify", -1, pBusinessId, pCid, pCharger, pAmount, pComment)
end)

RPC.register("ev-business:phone:charge", function(pSource, pBusinessId, pCid, pCharger, pAmount)
...
RPC.register("chargeCustomer", function(pSource, pBusinessId, pCid, pComment, pCharger, pAmount, pSrc, pDate)
    ...
    local user = exports["ev-base"]:getModule("Player"):GetUser(tonumber(pSrc))
...
RPC.register("ev-business:transferBank", function(pSource, pBusinessId, pAmount)
    local update = Await(SQL.execute("UPDATE businesses SET bank = bank + @amount WHERE business_id = @business_id", {
        ["amount"] = tonumber(pAmount),
        ["business_id"] = pBusinessId
    }))
