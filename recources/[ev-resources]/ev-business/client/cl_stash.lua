...
RegisterInterfaceCallback("ev-business:stash:enteredAuthCode", function(data, cb)
  cb({ data = {}, meta = { ok = true, message = "done" } })
  exports["ev-interface"]:closeApplication("textbox")
  hasPdAuthCode = true
end)
AddEventHandler("ev-interface:application-closed", function(name)
...
function enterPoly(name, data)
  ...
  exports["ev-interface"]:showInteraction("[E] " .. name)
end
...
AddEventHandler("ev-business:stash:creationMenu", function ()
  ...
  exports["ev-interface"]:openApplication("textbox", creationMenu)
end)
...
AddEventHandler("ev-business:client:changeStashModel", function (pData, pEntity)
  ...
  exports["ev-interface"]:openApplication("textbox", menuData)
end)

RegisterInterfaceCallback("ev-business:client:updateStashModel", function(pData, pCb) 
...
RegisterInterfaceCallback("ev-business:client:createStash", function(pData, pCb) 
  pCb({ data = {}, meta = { ok = true, message = "done" } })
  exports["ev-interface"]:closeApplication("textbox")
