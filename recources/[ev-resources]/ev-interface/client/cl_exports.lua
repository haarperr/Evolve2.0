...
RegisterNetEvent("ev-interface:open-application")
AddEventHandler("ev-interface:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("ev-interface:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("ev-interface:soundPlay")
AddEventHandler("ev-interface:soundPlay", function(name, volume, loop)
