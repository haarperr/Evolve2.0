        ...
        var FT = function (SU) {
            ...
            return (
              Fl('uiMessage', function (ch) {
                ...
                'badge' === ch.app &&
                  ...
                  SQ(true),
                  setTimeout(function () {
                    Fd('ev-interface:closeApp', {}).then(function (cM) {
                      true === cM.meta.ok &&
                        Fd('ev-interface:applicationClosed', {
                          name: 'badge',
                          fromEscape: true,
                        }).then(function (cb) {
            ...
            Object(F4.useEffect)(
              function () {
                var cm = function (cs) {
                  Fg.includes(cs.code) &&
                    ('eye' === cv
                      ? Fd('ev-interface:closeApp', {}).then(function (cR) {
                          true === cR.meta.ok &&
                            Fd('ev-interface:applicationClosed', {
                              name: 'eye',
                              fromEscape: true,
          ...
          Fp = function (SU) {
            ...
            var cr = function (cB, ch, cO, cP, cN, cJ) {
              ...
              void 0 !== cB
                ? (void 0 !== cO && false !== cO) ||
                  Fd('ev-interface:closeApp', {}).then(function (cb) {
                    true === cb.meta.ok &&
                                    ...
                                    Object(FG.jsx)(Ff.a, {
                                      ...
                                      onClick: function () {
                                        return (
                                          ...
                                          (co = ct.parameters),
                                          void Fd(
                                            'ev-interface:targetSelectOption',
                                            {
                                              entity: cB,
                                              option: {
                                                event: cU,
                                      ...
                                      children: Object(FG.jsx)(S0.a, {
                                        onClick: function () {
                                          cM(true),
                                            cv(true),
                                            Fd(
                                              'ev-interface:getBankAccountsByStateID',
                                              { stateid: cR }
                                            ).then(function (cp) {
                                              cd('')
                                              cM(false)
                ...
                'range-picker' === c4.app &&
                  (true === c5.show
                    ? (Sx(true),
                      ...
                      void 0 !== c5.submitUrl
                        ? c3(c5.submitUrl)
                        : c3('ev-interface:rangePickerValues'))
                      ...
                      children: Object(FG.jsx)('div', {
                        children: Object(FG.jsx)(S0.a, {
                          onClick: function () {
                            ...
                            Fd('ev-interface:closeApp', {}).then(function (cw) {
                              true === cw.meta.ok &&
                                Fd(''.concat(c7), {
                                  key: cS,
                                  values: cZ,
                ...
                var cC = Object(Fs.a)(
                  FR.a.mark(function cQ(cx) {
                    var cA = {
                      ...
                      NmIgd: 'ev-interface:fetchContracts',
                      nChUi: 'Kanjo',
                      DfKlA: 'coquettec',
                              ...
                              children: Object(FG.jsxs)(SZ.a, {
                                ...
                                children: [
                                  ...
                                  Object(FG.jsx)(S0.a, {
                                    onClick: function () {
                                      c4(false)
                                      Fd('ev-interface:closeApp', {}).then(
                                        function (aJ) {
                                          true === aJ.meta.ok &&
                                            Fd(
                                              'ev-interface:applicationClosed',
                                              {
                                                name: 'clothing',
                                                fromEscape: true,
                                              }
