...
function Spawn.obtainWorldSpawnPos(spawnInfo, spawnName)
    local found = false
    ...
    if spawnName == "Last Location" then
        found = Spawn.Crash
        Spawn.Crash = nil
    end
    ...
    if Spawn.businessSpawnsInfo[spawnInfo] ~= nil then
        found = Spawn.businessSpawnsInfo[spawnInfo].pos
    end
