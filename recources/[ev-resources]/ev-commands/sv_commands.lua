...
AddEventHandler("commands:player:login",function()
    ...
    TriggerClientEvent("chat:addSuggestion", src, "/showmenu", "Open Hud settings!")
    TriggerClientEvent("chat:addSuggestion", src, "/ooc", "OOC!")
    TriggerClientEvent(
...
AddEventHandler("commands:reset:login",function()
    ...
    TriggerClientEvent("chat:removeSuggestion", src, "/ooc")
    TriggerClientEvent(
