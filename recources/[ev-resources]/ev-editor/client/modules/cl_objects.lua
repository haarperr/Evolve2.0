...
RegisterNetEvent("ev-editor:buildName")
AddEventHandler("ev-editor:buildName", function(name, objects)
    if objects then
...
RegisterNetEvent("ev-editor:destroyName")
AddEventHandler("ev-editor:destroyName", function(name)
    cleanUpArea(name)
