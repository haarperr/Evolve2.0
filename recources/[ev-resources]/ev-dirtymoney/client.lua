...
RegisterNetEvent("ev-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("ev-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("ev-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("ev-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('ev-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("ev-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("ev-dirtymoney:alterDirtyMoney","ItemDrop",amount)
