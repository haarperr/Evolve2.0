...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 1.8 },
        isEnabled = function(pEntity, pContext)
            return exports['ev-carbombs']:isThisVehicleABomb(NetworkGetNetworkIdFromEntity(pEntity))
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 7.0 },
        isEnabled = function(pEntity, pContext)
            return (isCloseToBoot(pEntity, PlayerPedId(), 2.0, pContext.model)) and not IsPedInAnyVehicle(PlayerPedId(), false)
        end
    }
}
...
--             icon = "car-crash",
--             event = 'unwind-carscrap:ScrapVehicle',
--             parameters = {}
--         }
--     },
--     options = {
--         distance = { radius = 3.0 },
--         isEnabled = function(pEntity, pContext)
--             return exports['unwind-carscrap']:InScrapLocation()
--         end
--     }
-- }
...
--     data = {
--         {
--             id = "vehicle_normal_scrap",
--             label = "Chop vehicle",
--             icon = "car-crash",
--             event = 'unwind-carscrap:StartCarScrappingProcess',
--             parameters = {}
--         }
--     },
--     options = {
--         distance = { radius = 3.0 },
--         isEnabled = function(pEntity, pContext)
--             return exports['unwind-carscrap']:InNormalScrapLocation()
--         end
--     }
-- }
    ...
    data = {
        {
            ...
            label = "Scratch Vin",
            icon = "eye-slash",
            event = "aspect-boosting:finish_scratch",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Grab goods",
            icon = "box",
            event = "deisrep-jobs:deliveryGrabGoods",
            parameters = {}
        }
    },
    options = {
