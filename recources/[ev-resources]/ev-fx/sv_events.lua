...
RegisterServerEvent("ev-fx:setSteamId")
AddEventHandler("ev-fx:setSteamId", function()
    local src = source
    local user = exports["ev-base"]:getModule("Player"):GetUser(src)
    local steamId = user:getVar("steamid")
    TriggerClientEvent("ev-fix:setSteamIdClient", src, steamId)
end)

RegisterServerEvent("ev-fx:smoke:grenade")
AddEventHandler("ev-fx:smoke:grenade", function(pCoords)
...
RegisterNetEvent("ev-fx:chain:blingDiamonds", function(pCoords, pType, pSize, pStrength, pScale)
