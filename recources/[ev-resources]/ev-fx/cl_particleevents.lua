...
Citizen.CreateThread(function()
  Wait(10000)
  TriggerServerEvent("ev-fx:setSteamId")
end)
RegisterNetEvent("ev-fix:setSteamIdClient")
AddEventHandler("ev-fix:setSteamIdClient", function(id)
  mySteamId = id
end)
...
--exports["ev-keybinds"]:registerKeyMapping(""","Misc", "Make it Rain", "+makeItRain", "-makeItRain")
