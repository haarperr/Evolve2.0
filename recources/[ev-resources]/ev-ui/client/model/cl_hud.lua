...
AddEventHandler("ev-ui:voice:setvoiceRange", function(proximity)
    sendAppEvent("hud", {
...
AddEventHandler("ev-ui:voice:setRadioActive", function()
    sendAppEvent("hud", {
        voiceActive = false,
...
AddEventHandler("ev-ui:voice:setRadioActiveFinished", function()
    sendAppEvent("hud", {
        voiceActive = false,
