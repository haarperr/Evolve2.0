...
exports['ev-ui']:openApplication('textbox', {
    callbackUrl = 'ev-ui:scenes:input', -> callbackUIName
    key = 1,
    items = {
        {
    ...
    local data = {
        {
            ...
            key = true,
            children = {
				{ title = "Confirm Purchase", action = "ev-ui:wheelchairPurchase", key = true }, -> action is name of UICallback
			},
        },
    }
...
RegisterUICallback("ev-ui:wheelchairPurchase", function(data, cb)
...
####
exports["ev-ui"]:taskBarSkill(timer, skillGapSent)
####
