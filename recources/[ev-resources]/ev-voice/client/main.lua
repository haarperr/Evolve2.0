...
AddEventHandler('ev-voice:settingsCallback', function(cb)
	cb(Cfg)
end)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('ev-voice:setTalkingMode', voiceMode)
	TriggerEvent("ev-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
RegisterKeyMapping('+cycleproximity', 'Cycle Proximity', 'keyboard', GetConvar('voice_defaultCycle', 'Y'))
...
RegisterNetEvent('ev-voice:toggleMute', toggleMute)
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('ev-voice_enableMicClicks', val)
	end
end
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('ev-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('ev-voice_enableMicClicks', tostring(true))
	else
