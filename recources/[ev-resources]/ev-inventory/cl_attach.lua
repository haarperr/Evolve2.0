...
local w = {
	...
	[9] = { ["type"] = 1, "M4", ["id"] = "1192676223", ["model"] = 'w_ar_m4', ["z"] = 0.0, ["rx"] = 0.0, ["ry"] = 0.0, ["rz"] = 0.0 },
	...
	[25] = { ["type"] = 1, "MP5", ["id"] = "736523883", ["model"] = 'w_sb_mp5', ["z"] = 0.1, ["rx"] = 0.0, ["ry"] = 0.0, ["rz"] = 0.0 },
	...
	-- MP7
	[42] = { ["type"] = 7, "MP7", ["id"] = "324215364", ["model"] = 'w_sb_microsmg', ["x"] = -0.04, ["y"] = 0.25, ["z"] = 0.01, ["rx"] = -176.0, ["ry"] = -138.0, ["rz"] = -8.0, ["pedBone"] = 24818 },

	-- Sledge Hammer
	[43] = { ["type"] = 1, "Sledge Hammer", ["id"] = "1923739240", ["model"] = 'w_me_sledgeham', ["z"] = 0.25, ["rx"] = 0.0, ["ry"] = -118.0, ["rz"] = 0.0 },

	[44] = { ["type"] = 7, "HK416", ["id"] = "-2084633992", ["model"] = 'W_AR_CARBINERIFLE', ["x"] = 0.0, ["y"] = 0.25, ["z"] = 0.01, ["rx"] = -176.0, ["ry"] = -148.0, ["rz"] = -8.0, ["pedBone"] = 24818 },
}
...
AddEventHandler("AttachWeapons", function()
	...
	DeleteAttached()
	for i = 1, #w do
		if exports["ev-inventory"]:getQuantity(w[i]["id"]) > 0 then
			...
			elseif w[i]["type"] == 4 and not sheathed then
				TriggerEvent("ev-inventory:attachmentsToggle", true, w[i]["id"])
				sheathed = true
...
function DeleteAttached()
	TriggerEvent("ev-inventory:attachmentsToggle", false)
	for i = 1, #ag do
		DeleteEntity(ag[i])
	end
	for i = 1, #ad do
