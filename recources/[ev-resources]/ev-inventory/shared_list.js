...
itemList['-2012211169'] = {
  ...
  craft: [
    [
      { itemid: 'aluminium', amount: 45 },
      { itemid: 'steel', amount: 45 },
    ],
    [
      { itemid: 'refinedaluminium', amount: 5 },
      { itemid: 'refinedsteel', amount: 5 },
...
itemList['-942620673'] = {
  ...
  craft: [
    ...
    [
      { itemid: 'refinedaluminium', amount: 41 },
      { itemid: 'refinedplastic', amount: 83 },
      { itemid: 'refinedrubber', amount: 41 },
    ]
  ],
  weight: 15,
  nonStack: true,
...
itemList['cloak'] = {
  ...
  model: '',
  image: 'np_cloak.png',
  information: 'Only to be used for some cloak and dagger shit by Novel management.',
};
...
itemList['livechicken'] = {
  fullyDegrades: true,
  decayrate: 0.25,
  displayname: 'Live Chicken',
  price: 1,
  weight: 10,
  nonStack: false,
  model: '',
  image: 'np_pet-chicken.png',
  information: 'A live chicken. Bawk bawk',
  };


  itemList['slaughteredchicken'] = {
    fullyDegrades: true,
    decayrate: 0.25,
    displayname: 'Slaughtered Chicken',
    price: 1,
    weight: 3,
    nonStack: false,
    model: '',
...
itemList['guerrochain'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'MS-13 Chain',
  craft: [[
    { itemid: 'goldbar', amount: 20 },
    { itemid: 'aluminium', amount: 1000 },
    { itemid: 'copper', amount: 1000 },
  ], [
    { itemid: 'goldbar', amount: 20 },
    { itemid: 'refinedaluminium', amount: 320 },
    { itemid: 'refinedcopper', amount: 320 },
  ]],
  price: 10,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'bl_guerrochain.png',
  information: 'Represent!',
  cgChainCraft: true,
};
...
itemList['stafftrash'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Staff Trash Can',
  price: 1,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'grouch.png',
  information: 'This is a Novel Staff Item, stealing it is against the rules.',
};
...
itemList['bborchids'] = {
  ...
  model: '',
  image: 'sorchids.png',
  information: 'A beautiful bunch of Orchids. <br> Wrapped with a Beetle Blooms sticker.',
};

itemList['bbsunflowers'] = {
  fullyDegrades: true,
  decayrate: 0.75,
  displayname: 'Bouquet of Sunflowers',
  price: 1,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'bsunflower.png',
  information: 'A spectacular sunny bouquet of Sunflowers. <br> Wrapped with a Beetle Blooms sticker.',
};

itemList['bbroses'] = {
  fullyDegrades: true,
  decayrate: 0.75,
  displayname: 'Bouquet of Roses',
  price: 1,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'broses.png',
  information: 'A stunning bouquet of Roses, for that special someone. <br> Wrapped with a Beetle Blooms sticker.',
};

itemList['bbvarious'] = {
  fullyDegrades: true,
  decayrate: 0.75,
  displayname: 'Bouquet of Various Flowers',
  price: 1,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'bvarious.png',
  information: 'A delightful assortment of Various Flowers. <br> Wrapped with a Beetle Blooms sticker.',
};

itemList['bbtulip'] = {
  fullyDegrades: true,
  decayrate: 0.75,
  displayname: 'Single Stem Tulip',
  price: 1,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'ptulip.png',
  information: 'A lovely Single Stem Tulip. <br> Wrapped with a Beetle Blooms sticker.',
};

itemList['bbcarnations'] = {
  fullyDegrades: true,
  decayrate: 0.75,
  displayname: 'Basket of Carnations',
  price: 1,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'bcarnations.png',
  information: 'A wonderful array of Carnations in a Basket. <br> Wrapped with a Beetle Blooms sticker.',
};

itemList['bbrainbowrose'] = {
  fullyDegrades: true,
  decayrate: 0.75,
  ...
  model: '',
  image: 'rrose.png',
  information: 'A breathtaking Raindow Rose. <br> Wrapped with a Beetle Blooms sticker.',
};

itemList['qtakis'] = {
  fullyDegrades: true,
  decayrate: 0.01,
  displayname: 'Fuego Takis',
  price: 5,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'qtakis.png',
  information: 'A staple in International Care Packages',
};
...
itemList['qspam'] = {
  ...
  model: '',
  image: 'qspam.png',
  information: 'A can of Meat? Quelle recommends frying it until it is really crispy!',
};

itemList['qbloodstew'] = {
  fullyDegrades: true,
  decayrate: 0.01,
  displayname: 'Blood Stew',
  price: 20,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'qbloodstew.png',
  information: 'A Classic dish from the Philippines',
};
...
itemList['qdrpepper'] = {
  ...
  model: '',
  image: 'qdrpepper.png',
  information: 'Delicious and Refreshing!',
};
...
itemList['qfruity'] = {
  ...
  model: '',
  image: 'qfruity.png',
  information: 'Quelle recommends putting this on your Ice Cream for a real treat!',
};

itemList['qmando'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Mandalorian Playing Cards',
  price: 15,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'qmando.png',
  information: 'WHERE IS BABY YODA?!',
};

itemList['qmarvel'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Marvel Playing Cards',
  price: 15,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'qmarvel.png',
  information: 'A deck of Super Cool Playing Cards',
};

itemList['qwowclassic'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  ...
  nonStack: false,
  model: '',
  image: 'qwowclassic.png',
  information: 'You hope to be as good as the legendary Quelle at World of Warcraft',
};

itemList['qbumblebee'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Bumblebee Action Figure',
  price: 15,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'qbumblebee.png',
  information: 'Autobots roll out!',
};

itemList['qmcree'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'McCree Action Figure',
  price: 15,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'qmcree.png',
  information: 'Quelles favorite character in Overwatch!',
};

itemList['qharley'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Harley Quinn LEGO Action Figure',
  price: 1,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'qharley.png',
  information: 'The baddest bitch in LEGO form!',
};

itemList['qbabyyoda'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Baby Yoda Plushie',
  price: 1,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'qbabyyoda.png',
  information: 'So cute you think of having one of your own! <br> +10 Cuddles',
};
...
itemList['purplegball'] = {
  ...
  nonStack: false,
  model: '',
  image: 'purplegball.png',
  information: '',
};

itemList['yellowgball'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Gumball',
  price: 1,
...
itemList['orangegball'] = {
  ...
  nonStack: false,
  model: '',
  image: 'orangegball.png',
  information: '',
};

itemList['crackedgball'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Gumball',
  price: 1,
...
itemList['pollito'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Pollito Valentino',
  price: 1,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'pollito.png',
  information: 'Not your average Chicken Tender',
};
...
itemList['cloutarmor'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Clout Armor',
  price: 1,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'cloutarmor.png',
  information: 'To protect you from randoms. <br> +100 Resistance to Stream Snipers <br> +50 Clout',
};
...
itemList['bbqpizza'] = {
  fullyDegrades: true,
  decayrate: 0.0,
  displayname: 'BBQ Pizza',
  price: 5,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'ev_bbq_pizza.png',
  information: '',
};
...
itemList['margheritapizza'] = {
  ...
  nonStack: false,
  model: '',
  image: 'ev_margharitta_pizza.png',
  information: '',
};
...
itemList['rice_balls'] = {
  ...
  nonStack: false,
  model: '',
  image: 'ev_riceballs.png',
  information: 'Rice Balls.',
  deg: true,
};

// Chicken Noodle Soup //

itemList['chicken_breast'] = {
  fullyDegrades: true,
  decayrate: 0.1,
...
itemList['noodles'] = {
  ...
  nonStack: false,
  model: '',
  image: 'ev_noodles.png',
  information: 'Noodles.',
  deg: true,
};

itemList['chicken_noodle_soup'] = {
  fullyDegrades: true,
  decayrate: 0.1,
...
itemList['whipped_cream'] = {
  ...
  nonStack: false,
  model: '',
  image: 'ev_whipped_cream.png',
  information: 'Cream.',
  deg: true,
};

itemList['strawberries'] = {
  fullyDegrades: true,
  decayrate: 0.1,
  ...
  nonStack: false,
  model: '',
  image: 'ev_strawberrys.png',
  information: 'Strawberries.',
  deg: true,
};

itemList['doki_doki_pancakes'] = {
  fullyDegrades: true,
  decayrate: 0.1,
  displayname: 'Doki Doki Pancakes',
  price: 18,
  weight: 2,
  nonStack: false,
  model: '',
  image: 'ev_doki_doki_pancakes.png',
  information: 'Cream.',
  deg: true,
};
...
itemList['chocolate_chips'] = {
  ...
  nonStack: false,
  model: '',
  image: 'ev_chocoalte_chips.png',
  information: 'Chocolate Chips.',
  deg: true,
};
...
itemList['chocolate_cake'] = {
  ...
  nonStack: false,
  model: '',
  image: 'ev_choc_cake.png',
  information: 'Chocolate Cake.',
  deg: true,
};

// Strawberry Shortcake //

itemList['strawberry_shortcake'] = {
  fullyDegrades: true,
  decayrate: 0.1,
  ...
  nonStack: false,
  model: '',
  image: 'ev_strawberry_shortcake.png',
  information: 'Strawberry Shortcake.',
  deg: true,
};
...
itemList['mechanic_breaks_part'] = {
  fullyDegrades: true,
  decayrate: 2,
  displayname: 'Break\'s Part',
  craft: [[
    { itemid: 'rubber', amount: 5 },
  ]],
  price: 10,
  ...
  nonStack: true,
  model: '',
  image: 'aspect_breaks_part.png',
  information: 'New Break Part',
};

itemList['mechanic_axle_part'] = {
  fullyDegrades: true,
  decayrate: 2,
  displayname: 'Axle Part',
  craft: [[
  ...
  nonStack: true,
  model: '',
  image: 'aspect_axle_part.png',
  information: 'New Axle Part',
};

itemList['mechanic_radiator_part'] = {
  fullyDegrades: true,
  decayrate: 2,
  displayname: 'Radiator Part',
  craft: [[
    { itemid: 'scrapmetal', amount: 5 },
  ]],
  price: 10,
  ...
  nonStack: true,
  model: '',
  image: 'aspect_cooling_part.png',
  information: 'New Radiator Part',
};

itemList['mechanic_clutch_part'] = {
  fullyDegrades: true,
  decayrate: 2,
  displayname: 'Clutch Part',
  craft: [[
    { itemid: 'scrapmetal', amount: 5 },
  ]],
  price: 10,
  ...
  nonStack: true,
  model: '',
  image: 'aspect_clutch_part.png',
  information: 'New Clutch Part',
};

itemList['mechanic_electronics_part'] = {
  fullyDegrades: true,
  decayrate: 2,
  displayname: 'Electronics Part',
  craft: [[
  ...
  nonStack: true,
  model: '',
  image: 'aspect_electronics_part.png',
  information: 'New Electronic Part',
};

itemList['mechanic_fuel_part'] = {
  fullyDegrades: true,
  decayrate: 2,
  displayname: 'Fuel Part',
  craft: [[
    { itemid: 'steel', amount: 5 },
  ]],
  price: 10,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'aspect_fuel_injector.png',
  information: 'New Electronic Part',
};

itemList['mechanic_transmission_part'] = {
  fullyDegrades: true,
  decayrate: 2,
  displayname: 'Transmission Part',
  craft: [[
    { itemid: 'aluminium', amount: 5 },
  ]],
  price: 10,
  ...
  nonStack: true,
  model: '',
  image: 'aspect_transmission_part.png',
  information: 'New Transmission Part',
};

itemList['mechanic_injector_part'] = {
  fullyDegrades: true,
  decayrate: 2,
  displayname: 'Injector Part',
  craft: [[
