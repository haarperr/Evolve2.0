...
function DPX.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('ev-base:sv:player_control_set',DPX.Controls.Current)
...
RegisterNetEvent("ev-base:cl:player_control")
AddEventHandler("ev-base:cl:player_control", function(controlTable)
...
RegisterNetEvent('ev-base:setcontrols')
AddEventHandler('ev-base:setcontrols', function()
	TriggerServerEvent('ev-base:sv:player_controls')
end)
