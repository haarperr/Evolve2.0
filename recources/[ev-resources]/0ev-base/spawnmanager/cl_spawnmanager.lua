...
function DPX.SpawnManager.InitialSpawn(self)
    Citizen.CreateThread(function()
        ...
        if new then TriggerEvent("ev-base:newCharacterSpawned") DoScreenFadeIn(500) end
...
-- RegisterNetEvent("ev-base:newCharacterSpawned")
-- AddEventHandler('ev-base:newCharacterSpawned', function()
--     DestroyAllCams(true)
--     TriggerEvent("raid_clothes:defaultReset")
--     FreezeEntityPosition(PlayerPedId(), false)
-- end)

RegisterNetEvent("ev-base:firstSpawn")
