...
PedEntries[#PedEntries+1] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not IsDisabled() and pEntity and pContext.flags['isPlayer'] and ((exports["ev-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
    end
}
...
MenuItems['peds:cuff'] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not isDead and ((exports["ev-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
        --return not IsDisabled() and pEntity and pContext.flags['isPlayer'] and not pContext.flags['isCuffed'] and ((exports["ev-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc))) and pContext.distance <= 1.2
    end
}
...
MenuItems['cuffs:blindfold'] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not isDead and ((exports["ev-inventory"]:hasEnoughOfItem("blindfold",1,false)))
...
MenuItems['cuffs:gag'] = {
  ...
  isEnabled = function(pEntity, pContext)
      return not isDead and ((exports["ev-inventory"]:hasEnoughOfItem("gag_sock",1,false)))
...
RegisterNetEvent('ev-mdw:open-mdw')
AddEventHandler('ev-mdw:open-mdw', function()
    ExecuteCommand('+mdw')
end)