...
AddEventHandler("ev-racing:recieveCreateData", function(pRaceName, pRaceType, pRaceThumbnail, pCheckpoints)
    local src = source
    ...
    TriggerClientEvent("ev-racing:addedRace", -1, {}, Races)
    TriggerClientEvent("DoLongHudText", src, "Race " .. pRaceName .. " created!")
end)

RPC.register("ev-racing:isRaceNameTaken", function(src, pRaceName)
