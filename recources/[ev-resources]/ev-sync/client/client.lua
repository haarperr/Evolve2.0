...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("ev-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("ev-sync:clientExecuteSyncNative")
AddEventHandler("ev-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
