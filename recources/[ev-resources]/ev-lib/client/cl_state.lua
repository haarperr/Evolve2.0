...
--[[function isDisabled()
    return exports["ev-base"]:getVar("dead") or
        exports["ev-base"]:getVar("handcuffed")
end]]

function hasPhone()
    return exports["ev-inventory"]:hasEnoughOfItem("mobilephone", 1, false) or
...
function hasKeys(pEntity)
    ...
    local hasKeys = exports["ev-vehicles"]:HasVehicleKey(pEntity)
...
function hasRepairItems(type)
    ...
    for i, v in pairs(items) do
        if exports["ev-inventory"]:hasEnoughOfItem(v, 1, false) then
            return true
        end
    end
