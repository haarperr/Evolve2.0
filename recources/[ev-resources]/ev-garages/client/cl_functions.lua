...
function SpawnVehicle(vehicle, pGarage, Fuel, customized, plate, IsViewing)
    ...
    if exports['ev-menu']:houseGarageCoords() ~= nil and exports['ev-menu']:NearHouseGarage() and exports['ev-menu']:NearHouseGarage2() then
        HousingSpawn = exports['ev-menu']:houseGarageCoords()
	...
	Citizen.CreateThread(function()			
        ...
        --RPC.execute("ev-wheelfitment_sv:getfuckingdata",veh, plate)
