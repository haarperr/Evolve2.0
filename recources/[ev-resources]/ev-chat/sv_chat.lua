...
RegisterServerEvent('ev-chat:me:Log')
AddEventHandler('ev-chat:me:Log', function(text)
    local src = source
    local user = exports["ev-base"]:getModule("Player"):GetUser(src)
    ...
    local connect = {
        {
          ["color"] = color,
          ["title"] = "** ev [ev-chat] | [/me] Log **",
          ["description"] = "Steam Name: "..pName.." \n Character Name: "..charInfo.first_name.." "..charInfo.last_name.." \n Message: "..text,
        }
      }
      PerformHttpRequest("https://discord.com/api/webhooks/1012083100047654952/KgLy8jvi8W4jZhYuFnUPpXB9AuUH8TDEE_aiYOJxvnvFIbDqYtw4ZQSoftANWRUv44m3", function(err, text, headers) end, 'POST', json.encode({username = "ev | Job Payout Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)