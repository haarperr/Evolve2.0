...
Citizen.CreateThread(function()
  exports["ev-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('ev-propattach:attach')
AddEventHandler('ev-propattach:attach', function(pPropItem, pTargetFunction)
