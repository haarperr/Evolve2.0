...
function LoadPhoneModule()
    ...
    RegisterNetEvent("rp:voice:phone:call:start")
    AddEventHandler("rp:voice:phone:call:start", StartPhoneCall)

    RegisterNetEvent("rp:voice:phone:call:end")
    AddEventHandler("rp:voice:phone:call:end", StopPhoneCall)
...
RegisterNetEvent("ev-voice:setTransmissionDisabled", function ()
    WasEventCanceled()
